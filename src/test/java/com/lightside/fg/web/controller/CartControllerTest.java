...
public class CartControllerTest extends GenericControllerTest {
    ...
    public void testGetCartWithID() throws Exception {
        this.mockMvc.perform(get("/api/v1/cart/init-cart-record-recordId-1000001"))
                ...
                .andExpect(jsonPath("$.cartItems[0].productId").value("111690ab-a981-4122-b2f3-2467647c47fc"))
                .andExpect(jsonPath("$.cartItems[0].primary.quantity").value("75"))
                .andExpect(jsonPath("$.cartItems[0].primary.unitOfMeasure").value("EACH"))
                .andExpect(jsonPath("$.cartItems[0].secondary.quantity").isEmpty())
                ...
                .andExpect(jsonPath("$.cartItems[1].productId").value("111690ab-a981-4122-b2f3-2467647c47fd"))
                .andExpect(jsonPath("$.cartItems[1].primary.quantity").value("10"))
                .andExpect(jsonPath("$.cartItems[1].primary.unitOfMeasure").value("EACH"))
                .andExpect(jsonPath("$.cartItems[1].secondary.quantity").isNotEmpty())
                .andExpect(jsonPath("$.cartItems[1].createdOn").isNotEmpty())
                .andExpect(jsonPath("$.cartItems[1].updatedOn").isNotEmpty())
                .andExpect(jsonPath("$.cartItems[1].price").value("10"))
